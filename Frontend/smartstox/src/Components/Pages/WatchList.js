  ...
  render() {
    return (
      <div className="watchlist">
        <Helmet>
          <title>Smart Stox | Watchlist</title>
        </Helmet>
        <section id="loader">
                ...
                <div className="watchlist container">
                  {(() => {
                    if (this.state.StockRow.length > 0) {
                      return (
                        <div className=" WatchListcard card border-light">
                          <div className="watchlistnotempty">
                            <div className="card-header">
                              <div className="row">
                                <div className="col-3">Stock Name</div>
                                <div className="col-3">Price</div>
                                <div className="col-3">Change</div>
                                <div className="col-3">Unrealised P/L</div>
                              </div>
                            </div>
                            {this.state.StockRow.map((item) => (
                              <div className="card-body">
                                <div className="row">
                                  <div className="col-3">
                                    <h6 className="wStockName">{item[0]}</h6>
                                    <span className="wExchange badge bg-primary">
                                      {item[1]}
                                    </span>
                                  </div>
                                  <div className="col-3">
                                    <span className="wStockPrice">
                                      {item[2]}
                                    </span>
                                  </div>
                                  <div className="col-3">
                                    <span className="wPerChange badge badge-soft-danger">
                                      {item[3]}%
                                    </span>
                                    <br></br>
                                    <span className="wChange badge badge-soft-danger ">
                                      {item[4]}
                                    </span>
                                  </div>
                                  <div className="col-3">
                                    <span className="wUnrealized badge badge-soft-danger">
                                      {item[5]}
                                    </span>
                                  </div>
                                </div>
